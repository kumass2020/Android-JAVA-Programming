package com.cookandroid.practice282_7;
...
import com.cookandroid.practice282_7.R;
...
//        tabDog = (ActionBar.Tab)findViewById(R.id.ivDog);

//        bar.setBackgroundDrawable(new ColorDrawable(0xFFFFFF));
